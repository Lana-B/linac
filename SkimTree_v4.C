...
void SkimTree_v4(int file_num_start,int file_num_end,string inFileStub,string outFileStub){
   ...
   for (int filenum=file_num_start;filenum<file_num_end;filenum++){
      ...
      string inFile=inFileStub+std::to_string(filenum)+".root";
      string outFile=outFileStub+std::to_string(filenum)+".root";
