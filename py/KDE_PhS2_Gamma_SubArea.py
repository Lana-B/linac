...
def runthing(args):
	...
	filename=f"/work/lb8075/PhaseSpaces/PhS2_{field_size}_p1_Gamma_v3/output*1.root"
	...
	for i in range(PBS_ID,PBS_ID+1):
		...
		newdf=newdf[abs(newdf['X'])<20][abs(newdf['Y'])<20]
		...
		newdf=newdf.astype('float32')
		newdf.to_root(f"/work/lb8075/PhaseSpaces/Generated_PhS2_Gammas_{field_size}/generatedGamma_PhS2_v3_{field_size}_{i}_file{n_file}.root", key='PhaseSpace')
