...
script="Main_PhS3_BigSensor_Flexible_airbox_noCopper.mac"
...
for mat in material:
    for sims in sim_type:
        for field_sz in field_s:
            ...
            with open(f"hadd_scripts/script_{mat}_{thick}_{sims}_{field_sz}_v6.pbs", 'w') as g:
            ...
            if ("FromPhS1" in sims):
                ...
                with open(f"hadd_scripts/script_{mat}_{thick}_{sims}_{field_sz}_elecx2_v6.pbs", 'w') as g:
                    print("#!/bin/bash \n" 
                    "#PBS -l walltime=00:59:00\n" 
                    "#PBS -j oe\n"
                    "#PBS -l select=1:ncpus=1\n"
