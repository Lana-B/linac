...
for i in range(file_num,file_num+1):
	...
	newdf=newdf[abs(newdf['X'])<30][abs(newdf['Y'])<30]
	...
	newdfsub.to_root(f"/work/lb8075/PhaseSpaces/Generated_PhS2_Electrons_{field_size}/generatedElectron_PhS2_v3_{field_size}_{i}.root", key='PhaseSpace')
