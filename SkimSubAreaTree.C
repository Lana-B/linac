...
void SkimSubAreaTree() {

   // gSystem->Load("$ROOTSYS/test/libEvent");
   for (int filenum=1;filenum<2;filenum++){
      //Get old file, old tree and set top branch address
      string inFile="output-lana2-PhS-e"+std::to_string(filenum)+".root";
      string outFile="Skimmed10x10mm-PhS-e"+std::to_string(filenum)+".root";
